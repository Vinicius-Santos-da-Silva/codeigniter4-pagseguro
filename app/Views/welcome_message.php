...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="<?php echo site_url('login/logout'); ?>">Sair</a></li>
			<li class="menu-item hidden"><a href="<?php echo site_url('login/logout'); ?>">+ Usuario</a></li>
		</ul>
	</div>

	<div class="heroe">

		<h1>Bem vindo ao Catavoto</h1>
