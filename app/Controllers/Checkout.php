...
class Checkout extends BaseController
{
    ...
    {
        \PagSeguro\Library::initialize();
        \PagSeguro\Library::cmsVersion()->setName("Catavoto")->setRelease("1.0.0");
        \PagSeguro\Library::moduleVersion()->setName("Catavoto")->setRelease("1.0.0");

        \PagSeguro\Configuration\Configure::setEnvironment('sandbox');//production or sandbox
        \PagSeguro\Configuration\Configure::setAccountCredentials(
            'vinicius.unisinos@hotmail.com',
            '3011d018-64a5-4eab-8f61-e370ba36e2d9ed92c73544c6a5ea16c4d14efb035ae3301e-86fc-4aea-96a7-8878718e949f'
        );
        \PagSeguro\Configuration\Configure::setCharset('UTF-8');// UTF-8 or ISO-8859-1
        \PagSeguro\Configuration\Configure::setLog(true, FCPATH.'../writable/logs/pagseguro.log');
